document.addEventListener("DOMContentLoaded", () => {
  ...
  /* ---- CAROUSEL (only exists on index.html) ---- */
  ...
  /* ---- SCROLL REVEAL (present on every page) ---- */
  ...
  /* ---- HAMBURGER (present on every page) ---- */
  ...
  const closeCareersCardBtn = document.getElementById("closeCareersCard");
  if (closeCareersCardBtn) {
    closeCareersCardBtn.addEventListener("click", () => {
      document.getElementById("careersCard").classList.remove("show");
    });
  }

  /* ---- MODAL (present on every page) ---- */
  ...
  /* ---- LEAD FORM (only exists on index.html and contact.html) ---- */
  ...
  /* ---- SMOOTH SCROLL (present on every page) ---- */
  ...
  /* ---- COUNTING NUMBERS (only exists on printer-solutions.html) ---- */
